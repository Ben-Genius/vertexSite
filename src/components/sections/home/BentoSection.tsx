  ...
  return (
    <section ref={sectionRef} className="bg-white py-24 lg:py-32 overflow-hidden px-2">
      <div className="max-w-[90rem] mx-auto">
        ...
        {/* Bento Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 auto-rows-[280px] md:auto-rows-[340px] lg:auto-rows-[380px]">
          ...
          >
            ...
            <div className="relative h-full p-8 lg:p-10 flex flex-col justify-between">
              <div className="w-11 h-11 rounded-xl bg-white/10 flex items-center justify-center transform group-hover:scale-110 group-hover:-rotate-12 transition-all duration-500 origin-bottom-left">
                <HardHat className="w-5 h-5 text-gold group-hover:text-white transition-colors duration-300" />
              </div>
              <div>
                <h3 className="text-[clamp(1.5rem,4vw,2.25rem)] font-bold text-white mb-3 leading-tight transform group-hover:translate-x-1 transition-transform duration-300">
          ...
          >
            <div className="w-11 h-11 rounded-xl bg-white/15 flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 origin-left">
          ...
          >
            <div className="w-11 h-11 rounded-xl bg-maroon/8 flex items-center justify-center group-hover:bg-maroon/15 transform group-hover:scale-110 group-hover:-rotate-3 transition-all duration-500 origin-left">
              <Globe className="w-5 h-5 text-maroon group-hover:text-gold transition-colors duration-300" />
            </div>
            <div className="transform group-hover:translate-x-1 transition-transform duration-300">
              <h3 className="text-[clamp(1.25rem,3vw,1.5rem)] font-bold text-charcoal mb-2 group-hover:text-maroon transition-colors duration-300">Ghana-Rooted,<br />Africa-Ready</h3>
          ...
          >
            <div className="w-11 h-11 rounded-xl bg-gold/15 flex items-center justify-center transform group-hover:scale-110 group-hover:-rotate-6 transition-all duration-500 origin-left">
              <Award className="w-5 h-5 text-gold group-hover:text-white transition-colors duration-300" />
            </div>
            <div className="transform group-hover:translate-x-1 transition-transform duration-300">
              ...
              <h3 className="text-[clamp(1.25rem,3vw,1.5rem)] font-bold text-white mb-4 group-hover:text-gold transition-colors duration-300">QHSE<br />Excellence</h3>
              <Link
                href="/qhse"
          ...
          >
            <div className="w-11 h-11 rounded-xl bg-maroon/8 flex items-center justify-center group-hover:bg-maroon/15 transform group-hover:scale-110 group-hover:rotate-[15deg] transition-all duration-500 origin-left">
          ...
          <motion.div
            ...
            className="sm:col-span-2 lg:col-span-2 rounded-2xl border border-charcoal/8 bg-sand/50 p-8 lg:p-14 flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-8 group" style={{ height: "auto", minHeight: "160px" }}
          >
            <div className="transform group-hover:translate-x-2 transition-transform duration-500">
              <div className="flex items-center gap-3 mb-4">
                <Target className="w-5 h-5 text-maroon transform group-hover:rotate-45 transition-transform duration-500" />
                <span className="label-caps text-maroon text-[9px]">Start a Project</span>
              </div>
              <h3 className="text-[clamp(1.5rem,4vw,2.25rem)] font-bold text-charcoal leading-tight">
