...
export const Carousel = ({ items, initialScroll = 0 }: CarouselProps) => {
  ...
  const handleCardClose = (index: number) => {
    if (carouselRef.current) {
      const cardWidth = isMobile() ? 230 : 384; // py-4 w-80 or w-96
        ...
        >
          ...
          <div
            className={cn(
              ...
              "max-w-7xl mx-auto" // remove max-w-7xl if you want it to span the full width
            )}
          >
          ...
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            >
              <button
                ...
                onClick={handleClose}
              >
                <IconX className="h-6 w-6 text-neutral-100 dark:text-neutral-800" />
              </button>
              <motion.p
